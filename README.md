...
- 街から鉱山、釣り、工房、探索、ギルド、博物館、BOSS城、記録、マイハウス、鉄道へ直接移動
...
- 鉄道・地域物流：山岳鉱夫、地域倉庫、馬車輸送、初期簡易貨物列車
- LQ自動化：積込、荷卸、整備、入出庫、予備編成交代
- 地域生産・馬車到着のLUNA CORE側時間精算
- サーバー確定game actionとaction ID重複防止
